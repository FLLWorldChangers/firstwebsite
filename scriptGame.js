...
noStroke, stroke, strokeWeight, textSize,
text, keyIsPressed, keyCode, UP_ARROW, 
...
function draw() {
  if (GameOn == true) {
    ...
    fill(255, 0, 0);
    ellipse(100, yPos_red, 30, 30); //x range of 85-115...changes size of ball
    //ideally ^^speed of lines + ^^ size ball + ^^ line length
    ...
    //what happens if GameOn ==== false end of draw()
    background(250, 223, 150);
    noStroke();
    fill(255, 0, 0);
    rect(50, 100, 300, 200, 60);
    //rect(x of top L, y of top L, width, Length, curves on corner)
    fill(250, 223, 150);
